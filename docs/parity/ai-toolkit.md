...
| Optional OpenAI-compatible provider | ✅ | Consumer-owned endpoint exposed only through `@libregrid/ai-toolkit/advanced`; **off by default**, explicit opt-in (`OpenAiCompatibleProvider`) |
