...
| #   | Action                                | Status                     | Notes                                                                                                                                                                                                                                                                                                                                                               |
| --- | ------------------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| A8  | **Publish 1.0.0** with npm provenance | ⚠️ ready for owner         | Phase 13 is complete; the release changeset (.changeset/phase-thirteen-100-release.md) bumps every package to 1.0.0. The [release workflow](../.github/workflows/release.yml) and [publishing guide](guides/publishing.md) are ready. Add the npm publish secret, run the workflow from `main`, then complete the verbatim quick-start check (phase-13 acceptance). |
