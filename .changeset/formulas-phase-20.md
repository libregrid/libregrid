---
'@libregrid/formulas': patch
'@libregrid/calculated-columns': patch
'@libregrid/cell-selection': patch
'@libregrid/all': patch
---

Add `@libregrid/formulas` — per-cell spreadsheet formulas (gap-plan A1, Phase 20) —
