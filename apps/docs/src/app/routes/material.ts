...
@Component({
  ...
  styles: `pre { overflow:auto; padding:1rem; border-radius:var(--lgr-radius-md); background:var(--mat-sys-surface-container); border:1px solid var(--mat-sys-outline-variant); } pre code { padding:0; border:0; background:transparent; } .buttons { display:flex; flex-wrap:wrap; gap:.75rem; align-items:center; }`,
  template: `
