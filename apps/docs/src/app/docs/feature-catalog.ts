...
export const DOCS_SECTIONS: readonly DocsSection[] = [
  ...
  { id: 'server', label: 'Serve and stream data' },
  ...
  { id: 'reference', label: 'Integrate and extend' },
];
...
export const DOCS_FEATURES: readonly DocsFeature[] = [
  ...
  },
  {
    ...
    section: 'start',
    packages: [],
    outcome: 'Compare what each package adds and what it requires, side by side.',
    boundary: 'Browser',
  ...
  },
  {
    ...
    outcome: 'Build pivot-table-style reports directly from detailed records.',
    boundary: 'Browser',
  ...
  },
  {
    ...
    outcome: 'Help users narrow large datasets to what matters, with filters they can see and reuse.',
    boundary: 'Both',
  ...
  },
  {
    ...
    outcome: 'Let users build and save detailed filters, and jump straight to any value.',
    boundary: 'Both',
  ...
  },
  {
    ...
    outcome: 'Keep very large datasets fast — the grid loads only what the user is looking at.',
    boundary: 'Both',
    keywords: ['ssrm', 'large data', 'datasource'],
  },
  {
    path: 'server-side-advanced',
    label: 'Server-Side Analytics',
    icon: 'analytics',
    section: 'server',
    packages: [
    ...
    outcome: 'Run filtering, grouping, and reporting on large datasets without downloading them first.',
    boundary: 'Both',
  ...
  },
  {
    ...
    outcome: 'Keep a user’s selections intact across filters, pages, and visits.',
    boundary: 'Both',
  ...
  },
  {
    ...
    outcome: 'Keep live data fresh by updating only the rows on screen.',
    boundary: 'Both',
  ...
  },
  {
    ...
    outcome: 'Let users add their own calculated columns without touching the underlying data.',
    boundary: 'Both',
  ...
  },
  {
    ...
    outcome: 'Let users shape their view of the data with plain-language requests, checked against your rules before anything changes.',
    boundary: 'Both',
    keywords: ['natural language', 'byom', 'structured outputs', 'openapi'],
  },
  {
    path: 'selection',
  ...
  },
  {
    ...
    outcome: 'Let teams review a full set of changes, then apply them all at once.',
    boundary: 'Both',
  ...
  },
  {
    ...
    outcome: 'Let users spot trends without leaving the table.',
    boundary: 'Browser',
  ...
  },
  {
    ...
    outcome: 'Bring LibreGrid into an Angular application with full framework support.',
    boundary: 'Browser',
    keywords: ['framework', 'signals', 'providers'],
  },
  {
    path: 'material',
    label: 'Material theme bridge',
    icon: 'palette',
    section: 'reference',
    packages: ['@libregrid/material'],
    outcome: 'Match LibreGrid to your Angular Material design automatically.',
    boundary: 'Browser',
  ...
  },
  {
    ...
    section: 'reference',
    packages: [],
    outcome: 'Look up exactly what each package provides and where to get it.',
    boundary: 'Browser',
